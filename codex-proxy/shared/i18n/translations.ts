export const translations = {
  en: {
    ...
    wechatSupportTitle: "WeChat support group",
    wechatSupportDesc: "Scan the QR code to join the customer service group.",
    wechatSupportTip: "Use WeChat to get help or follow service updates.",
    wechatSupportFallback: "QR image could not be loaded. Please refresh and try again.",
  ...
  zh: {
    ...
    refresh: "\u5237\u65b0",
    updatedAt: "\u66f4\u65b0\u4e8e",
    wechatSupportTitle: "\u5fae\u4fe1\u5ba2\u670d\u7fa4",
    wechatSupportDesc: "\u626b\u63cf\u4e8c\u7ef4\u7801\uff0c\u52a0\u5165\u5ba2\u670d\u7fa4\u54a8\u8be2\u3002",
    wechatSupportTip: "\u4f7f\u7528\u5fae\u4fe1\u83b7\u53d6\u5e2e\u52a9\u6216\u670d\u52a1\u66f4\u65b0\u3002",
    wechatSupportFallback: "\u4e8c\u7ef4\u7801\u56fe\u7247\u52a0\u8f7d\u5931\u8d25\uff0c\u8bf7\u5237\u65b0\u540e\u91cd\u8bd5\u3002",
    footer:
