<template>
  <div class="card">
    ...
    <div class="px-4 py-4">
      ...
      <div v-else-if="status && !status.feature_enabled" class="flex items-center gap-3 py-2">
        <div class="flex-shrink-0 rounded-lg bg-gray-100 p-2 dark:bg-dark-700">
      ...
      <!-- 2FA Enabled -->
      <div v-else-if="status?.enabled" class="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
