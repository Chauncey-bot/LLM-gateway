export default {
  ...
  home: {
    ...
    globalGateWay: 'Global AI Gateway',
    navFeatures: 'Highlights',
    navModels: 'Model Access',
    navWorkflow: 'Workflow',
    getApiKey: 'Get API Key',
    heroBadge: 'Built for global model access, reliable routing, and developer productivity',
    heroParagraph:
      'PYTHAGORAS is built for global model routing and developer integrations, delivering more reliable routing, a unified API, multi-upstream policy management, and a better experience for Coding Plan workflows—so teams can integrate, ship, and scale faster.',
    viewCapabilities: 'View Capabilities',
    metaUnifiedTitle: 'Unified Access',
    metaUnifiedDesc: 'One API for Claude, GPT, Gemini, and other leading models.',
    metaStableTitle: 'Reliable Routing',
    metaStableDesc: 'Smarter routing, failover, and disaster recovery for production use.',
    metaCodingDesc: 'Optimized for developer workflows, long sessions, and toolchain integration.',
    cardModelRouting: 'Model Routing',
    cardMoreModels: 'Claude · GPT · Gemini · More',
    chipFailover: 'Failover',
    chipLoadBalance: 'Load Balancing',
    chipQuota: 'Quota Management',
    cardOptimizedDesc: 'Optimized for tool calls, long context, and production workloads',
    cardUpstreamStatus: 'Upstream Status',
    cardDevExperience: 'Developer Experience',
    cardDevExperienceDesc: 'Faster onboarding, a unified API, and clearer ops workflows',
    consoleTitle: 'AI Gateway Console',
    coreAdvantagesLabel: 'Key Advantages',
    coreAdvantagesTitle:
      'Make it easier to use the latest global models while balancing cost, stability, and integration efficiency',
    coreAdvantagesDesc:
      'Six core value points presented upfront so visitors immediately understand why this service is worth choosing.',
    advantageLowBarrierTitle: 'Low Barrier to Start',
    advantageLowBarrierDesc: 'Get started quickly with the latest global models—no complex setup.',
    advantageLowerCostTitle: 'Lower Cost',
    advantageLowerCostDesc: 'Optimized call strategies to significantly reduce model costs.',
    advantageReliableTitle: 'Reliable',
    advantageReliableDesc: 'Multi-route scheduling to improve API availability.',
    advantageDevFriendlyTitle: 'Developer Friendly',
    advantageDevFriendlyDesc: 'Unified API for simpler integration.',
    advantageRichScenariosTitle: 'Rich Scenarios',
    advantageRichScenariosDesc: 'Covers content, support, office, coding, and more.',
    advantageEnterpriseControlTitle: 'Enterprise Control',
    advantageEnterpriseControlDesc: 'Supports analytics, limits, and cost management.',
    modelsTitle: 'Connect to leading global models in a more unified and controllable way',
    modelsDesc:
      'Ideal for AI app development, SaaS integrations, internal enterprise tools, proxy platforms, and multi-model orchestration for developer workflows.',
    modelsClaudeTitle: 'Claude Series',
    modelsClaudeDesc: 'Great for high-quality chat, analysis, long-form reasoning, and complex tool calls.',
    modelsGptTitle: 'GPT Series',
    modelsGptDesc: 'Great for versatile generation, product embedding, and general developer platform use cases.',
    modelsGeminiTitle: 'Gemini and More',
    modelsGeminiDesc:
      'Broader model choices and future expansion, keeping the platform flexible at every stage.',
    workflowTitle: 'A clearer product journey for development teams',
    workflowDesc:
      'From getting an API key to model calls and upstream management, to workflow integrations—everything is clearer and more complete.',
    workflowStepGetKeyTitle: 'Get a Key',
    workflowStepGetKeyDesc: 'Register to get a unified API key and reduce multi-platform integration friction.',
    workflowStepConfigRouteTitle: 'Configure Routing',
    workflowStepConfigRouteDesc: 'Configure routing and usage rules by model, strategy, or project scenario.',
    workflowStepIntegrateTitle: 'Integrate & Ship',
    workflowStepIntegrateDesc:
      'Integrate the unified API into apps, agents, SaaS products, or developer workflows.',
    workflowStepScaleTitle: 'Scale Reliably',
    workflowStepScaleDesc:
      'Use monitoring, billing, limits, and upstream management for stable production operation.',
    ctaDesc: 'More trustworthy, and built for developers.',
    footerCopyright: '© 2026 PYTHAGORAS · Global AI Gateway',
    footerIcp: 'ICP Filing No. 2025132969-1',
    footer: {
  ...
  // Setup Wizard
  setup: {
    title: 'PYTHAGORAS Setup',
    description: 'Configure your PYTHAGORAS instance',
    database: {
  ...
  auth: {
    ...
    referralCodePlaceholder: "Enter a friend's referral code (optional)",
    referralCodeHint: 'It will be filled automatically when you open a personal invite link.',
  ...
  dashboard: {
    ...
    heroDescription: 'Today requests, token usage, and key status are summarized here, with common actions ready on the side.',
    balance: 'Balance',
    apiKeys: 'API Keys',
    todayRequests: 'Today Requests',
    todayCost: 'Today Cost',
    ...
    activePlanKicker: 'Active Plan',
    activePlanTitle: 'Active subscription plans',
    viewAll: 'View all',
    noActivePlans: 'No active subscription plans',
    active: 'Active',
    expiresAt: 'Expires at',
    usageLimits: 'Usage limits',
    referralKicker: 'Referral & Points',
    referralTitle: 'Referral and points statistics',
    viewReferrals: 'View referrals',
    referralUnavailable: 'Referral statistics are temporarily unavailable',
    currentPoints: 'Current points',
    invitedFriends: 'Invited friends',
    rewardOrders: 'Reward orders',
    totalEarned: 'Total earned',
    neverExpires: 'Never expires',
    expiresOn: 'Expires on {date}',
    daysRemaining: '{date}, {days} day(s) remaining',
    limitDailyUsd: 'Day ${amount}',
    limitWeeklyUsd: 'Week ${amount}',
    limitMonthlyUsd: 'Month ${amount}',
    unlimited: 'Unlimited'
  },
  ...
  keys: {
    ...
    batchTargetPlaceholder: 'Select target group',
    batchApply: 'Apply to selected',
    batchNoSelection: 'Please select API keys first',
    batchNoTarget: 'Please select a target group',
    batchGroupSuccess: 'Successfully updated {count} key(s) group',
    batchGroupPartial: 'Batch update complete: {success} succeeded, {failed} failed',
    batchGroupFailed: 'Failed to update key groups in batch',
    created: 'Created',
    ...
    dailyLimitPlaceholder: 'Enter daily limit in USD',
    dailyLimitHint: 'Set the maximum amount this key can spend per day. 0 = unlimited.',
    dailyLimitUsed: 'Used Today',
    resetDailyLimitUsed: 'Reset today usage to 0',
    reset: 'Reset',
  ...
  usage: {
    ...
    keySpendDistribution: 'Key Spend Distribution',
    keySpendDistributionHint: 'Spend share for each API key in the current filters.',
    noKeySpendData: 'No API key spend data for the current filters.',
  ...
  referrals: {
    title: 'Referrals',
    description: 'Share your invite link, track referral rewards, and redeem points',
    kicker: 'Referral Center',
    heroTitle: 'Referral Rewards Console',
    heroDescription: 'Share your dedicated invite link. When friends purchase or renew successfully, points are awarded automatically.',
    currentPoints: 'Current Points',
    invitedFriends: 'Invited Friends',
    rewardOrders: 'Reward Orders',
    inviteCardKicker: 'Dedicated Invite',
    inviteCardTitle: 'Invite friends and earn points',
    inviteUrlLabel: 'Dedicated invite link',
    copyLink: 'Copy Link',
    referralCode: 'Referral Code',
    copyCode: 'Copy Code',
    qrAlt: 'Invite QR code',
    scanHint: 'Scan to open the invite link',
    overview: 'Referral Overview',
    myInviterCode: 'My Inviter Referral Code',
    noInviterBound: 'Not bound',
    totalEarned: 'Total Earned',
    totalSpent: 'Total Used',
    bindCodeLabel: 'Friend referral code',
    bindCodePlaceholder: 'Enter referral code',
    bind: 'Bind',
    binding: 'Binding',
    bindHint: 'Each account can bind a referral relationship only once.',
    alreadyBoundHint: 'This account already has an inviter referral code bound and cannot be bound again.',
    rewardRules: 'Reward Rules',
    loadFailed: 'Failed to load referral features',
    linkCopied: 'Invite link copied',
    codeCopied: 'Referral code copied',
    bindSuccess: 'Referral relationship bound successfully',
    bindFailed: 'Failed to bind referral relationship',
    rules: {
      share: {
        title: 'Share invite link',
        description: 'Friends register through your link to create a referral relationship.'
      },
      purchase: {
        title: 'Friend completes purchase',
        description: 'Points are issued according to backend rules after the order is completed.'
      },
      renewal: {
        title: 'Renewals earn rewards automatically',
        description: 'When friends renew successfully later, points are also issued automatically by backend rules.'
      },
      mall: {
        title: 'Redeem in Points Mall',
        description: 'Point redemptions and point ledger records have moved to the standalone Points Mall page.'
      }
    }
  },
  ...
  pointsMall: {
    title: 'Points Mall',
    description: 'Redeem subscription benefits with referral reward points, and review recent point income, deductions, and redemption records.',
    kicker: 'Points Mall',
    currentPoints: 'Current Points',
    totalEarned: 'Total Earned',
    totalSpent: 'Total Used',
    redemptionTitle: 'Point Redemption',
    redemptionDescription: 'Redeem subscription plans with points. Successful redemptions are written to the point ledger automatically.',
    emptyCatalog: 'No redeemable plans available',
    validityDays: '{days} days',
    pointsCost: '{points} points',
    referencePrice: 'Reference price {amount}',
    redeeming: 'Redeeming',
    redeemNow: 'Redeem Now',
    insufficientPoints: 'Not Enough Points',
    ledgerTitle: 'Point Ledger',
    ledgerDescription: 'Recent point rewards, deductions, and redemption records.',
    emptyLedger: 'No point ledger records yet',
    pagination: 'Total {total} records, page {page}',
    loadFailed: 'Failed to load Points Mall',
    ...
    ledgerTypes: {
      ...
      renewalReward: 'Renewal Reward',
      redeemSubscription: 'Subscription Redemption',
      adminAdjustment: 'Admin Adjustment'
    }
  },
  ...
  admin: {
    ...
    subscriptions: {
      ...
      quotaResetSuccess: 'Quota reset successfully',
      resetQuotaBackendUnavailable: 'Backend service is temporarily unavailable. Please try again later or contact administrator.',
      failedToResetQuota: 'Failed to reset quota',
    ...
    accounts: {
      ...
      types: {
        ...
        soraApiKeyHint: 'Connect to another PYTHAGORAS or compatible API',
      ...
      soraUpstreamBaseUrlHint: 'Upstream Sora service URL (another PYTHAGORAS instance or compatible API)',
    ...
    settings: {
      ...
      linuxdo: {
        ...
        description: 'Configure LinuxDo Connect OAuth for PYTHAGORAS end-user login',
      ...
      site: {
        ...
        siteName: 'Site Name',
        siteNamePlaceholder: 'PYTHAGORAS',
      ...
      smtp: {
        ...
        fromName: 'From Name',
        fromNamePlaceholder: 'PYTHAGORAS',
        useTls: 'Use TLS',
  ...
  userSubscriptions: {
    ...
    trafficQuotaBonus: 'Today\'s traffic pack bonus',
    trafficPack: 'Today\'s Traffic Pack',
    trafficPackQuota: 'Today\'s quota increased from {base} to {total}',
    trafficPackExpires: 'Expires at {time}; your plan quota will then be restored',
    subscriptionQuotaReset: 'Subscription quota resets in {time}',
    windowNotActive: 'Awaiting first use',
    usageOf: '{used} of {limit}',
    resetQuota: 'Reset Today Quota',
    resetQuotaTitle: 'Reset Today Quota',
    resetQuotaConfirm:
      'This will deduct 1 day of validity and reset today\'s used quota for {name}. Continue?',
    resetQuotaConfirmAction: 'Reset now',
    resetQuotaSuccess: 'Today\'s quota reset successfully and 1 day validity deducted',
    resetQuotaOnlyOwn: 'You can only reset quotas for your own subscriptions',
    resetQuotaNotActive: 'Only active subscriptions can be reset',
    resetQuotaFailed: 'Failed to reset quota',
    resetQuotaServiceUnavailable: 'Backend service is temporarily unavailable. Please try again later or contact administrator.',
  ...
  onboarding: {
    ...
    user: {
      welcome: {
        title: '👋 Welcome to PYTHAGORAS',
        description: '<div style="line-height: 1.8;"><p style="margin-bottom: 16px;">Hello! Welcome to the PYTHAGORAS AI service platform.</p><p style="margin-bottom: 12px;"><b>🎯 Quick Start:</b></p><ul style="margin-left: 20px; margin-bottom: 16px;"><li>🔑 Create API Key</li><li>📋 Copy key to your application</li><li>🚀 Start using AI services</li></ul><p style="color: #10b981; font-weight: 600;">Just 1 minute, let\'s get started →</p></div>',
        nextBtn: 'Start 🚀',
        prevBtn: 'Skip'
      },
      keyManage: {
