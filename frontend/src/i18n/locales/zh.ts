export default {
  ...
  home: {
    ...
    globalGateWay: '全球 AI 网关',
    navFeatures: '功能亮点',
    navModels: '模型接入',
    navWorkflow: '使用流程',
    getApiKey: '获取 API 密钥',
    heroBadge: '面向全球模型接入、稳定中转与开发效率而打造',
    heroParagraph:
      'PYTHAGORAS 面向全球模型中转与开发者接入场景，提供更稳定的模型路由、统一 API 调用、多上游策略管理，以及更适合 Coding Plan 场景的产品体验，帮助团队更快完成集成、上线与扩展。',
    viewCapabilities: '查看产品能力',
    metaUnifiedTitle: '统一接入',
    metaUnifiedDesc: '一个 API 接入 Claude、GPT、Gemini 等主流模型能力。',
    metaStableTitle: '稳定中转',
    metaStableDesc: '更智能的路由、故障切换与容灾能力，适合生产级使用场景。',
    metaCodingDesc: '更适合开发者工作流、长会话与工具链集成场景。',
    cardModelRouting: '模型路由',
    cardMoreModels: 'Claude · GPT · Gemini · 更多模型',
    chipFailover: '故障切换',
    chipLoadBalance: '负载均衡',
    chipQuota: '配额管理',
    cardOptimizedDesc: '针对工具调用、长上下文与生产使用场景进行了优化',
    cardUpstreamStatus: '上游状态',
    cardDevExperience: '开发体验',
    cardDevExperienceDesc: '接入更快，接口更统一，运维流程更清晰',
    consoleTitle: 'AI 网关控制台',
    coreAdvantagesLabel: '核心优势',
    coreAdvantagesTitle: '让国内用户更轻松地使用国外最新大模型，同时兼顾成本、稳定性与接入效率',
    coreAdvantagesDesc:
      '把用户最关心的 6 个价值点直接放到首页核心卖点区，让访客一眼看懂这个服务为什么值得选择。',
    advantageLowBarrierTitle: '低门槛接入',
    advantageLowBarrierDesc: '快速开始使用国外最新大模型，无需复杂准备。',
    advantageLowerCostTitle: '更低使用成本',
    advantageLowerCostDesc: '优化调用方案，显著降低模型成本。',
    advantageReliableTitle: '稳定可靠',
    advantageReliableDesc: '多路由调度，提升接口可用性。',
    advantageDevFriendlyTitle: '开发友好',
    advantageDevFriendlyDesc: '统一 API，接入更简单。',
    advantageRichScenariosTitle: '场景丰富',
    advantageRichScenariosDesc: '覆盖内容、客服、办公、代码等需求。',
    advantageEnterpriseControlTitle: '企业可控',
    advantageEnterpriseControlDesc: '支持统计、限额与成本管理。',
    modelsTitle: '用更统一、更可控的方式接入全球主流模型能力',
    modelsDesc:
      '适合 AI 应用开发、SaaS 接入、企业内部工具、代理平台，以及面向开发场景的多模型编排需求。',
    modelsClaudeTitle: 'Claude 系列',
    modelsClaudeDesc: '适合高质量对话、分析、长文本推理以及复杂工具调用场景。',
    modelsGptTitle: 'GPT 系列',
    modelsGptDesc: '适合多样化内容生成、产品能力嵌入与通用开发平台场景。',
    modelsGeminiTitle: 'Gemini 及更多模型',
    modelsGeminiDesc: '面向更广泛的模型选择与后续扩展，让平台在不同阶段都能保持灵活性。',
    workflowTitle: '更适合开发团队理解的产品使用路径',
    workflowDesc:
      '从获取 API 密钥到模型调用、上游管理，再到开发工作流集成，整体路径更清晰、更完整。',
    workflowStepGetKeyTitle: '获取密钥',
    workflowStepGetKeyDesc: '注册后获取统一 API 密钥，降低多平台接入门槛。',
    workflowStepConfigRouteTitle: '配置路由',
    workflowStepConfigRouteDesc: '按模型、策略或项目场景配置路由与使用规则。',
    workflowStepIntegrateTitle: '集成上线',
    workflowStepIntegrateDesc: '将统一 API 集成到应用、Agent、SaaS 产品或开发工作流中。',
    workflowStepScaleTitle: '稳定扩展',
    workflowStepScaleDesc: '通过监控、计费、限额与上游管理实现更稳定的生产环境运行。',
    ctaDesc: '更值得信赖的产品, 也更适合开发者使用。',
    footerCopyright: '© 2026 PYTHAGORAS · 全球 AI 网关',
    footerIcp: 'ICP Filing No. 沪ICP备2025132969号-1',
    footer: {
  ...
  // Setup Wizard
  setup: {
    title: 'PYTHAGORAS 安装向导',
    description: '配置您的 PYTHAGORAS 实例',
    database: {
      title: '数据库配置',
  ...
  auth: {
    ...
    referralCodePlaceholder: '输入好友推荐码（可选）',
    referralCodeHint: '通过专属邀请链接打开时会自动填入。',
  ...
  dashboard: {
    ...
    heroTitle: '{name}，欢迎回来',
    heroDescription: '今日请求、Token 消耗和密钥状态已汇总在这里，常用操作可以从右侧快速进入。',
    balance: '余额',
    apiKeys: 'API 密钥',
    todayRequests: '今日请求',
    todayCost: '今日消费',
    ...
    activePlanKicker: '生效套餐',
    activePlanTitle: '正在生效的订阅计划',
    viewAll: '查看全部',
    noActivePlans: '暂无生效中的订阅计划',
    active: '生效中',
    expiresAt: '到期时间',
    usageLimits: '用量额度',
    referralKicker: '推荐与积分',
    referralTitle: '推荐和积分统计',
    viewReferrals: '查看推荐有礼',
    referralUnavailable: '推荐统计暂不可用',
    currentPoints: '当前积分',
    ...
    neverExpires: '长期有效',
    expiresOn: '{date} 到期',
    daysRemaining: '{date}，剩余 {days} 天',
    limitDailyUsd: '日 ${amount}',
    limitWeeklyUsd: '周 ${amount}',
    limitMonthlyUsd: '月 ${amount}',
    unlimited: '不限额度'
  },
  ...
  keys: {
    ...
    quotaUsed: '已用额度',
    dailyLimit: '每日额度限制',
    dailyLimitPlaceholder: '输入 USD 每日额度限制',
    dailyLimitHint: '设置此密钥每天可消费的最大金额。0 = 无限制。',
    dailyLimitUsed: '今日已用额度',
    resetDailyLimitUsed: '将今日已用额度重置为 0',
    reset: '重置',
  ...
  usage: {
    ...
    apiKeyFilter: 'API 密钥',
    allApiKeys: '全部密钥',
    keySpendDistribution: 'Key消费分布',
    keySpendDistributionHint: '当前筛选条件下每个 API Key 的消费占比。',
    noKeySpendData: '当前筛选条件下暂无 Key 消费数据。',
  ...
  referrals: {
    title: '推荐有礼',
    description: '分享邀请链接，查看推荐奖励与积分兑换',
    kicker: '推荐中心',
    heroTitle: '推荐有礼控制台',
    heroDescription: '分享专属邀请链接，好友购买或续费成功后自动获得积分。',
    currentPoints: '当前积分',
    invitedFriends: '已邀请',
    rewardOrders: '奖励订单',
    inviteCardKicker: '专属邀请',
    inviteCardTitle: '邀请好友，赚取积分',
    inviteUrlLabel: '专属邀请链接',
    copyLink: '复制链接',
    referralCode: '推荐码',
    copyCode: '复制推荐码',
    qrAlt: '邀请二维码',
    scanHint: '扫码打开邀请链接',
    overview: '推荐概览',
    myInviterCode: '我的邀请人推荐码',
    noInviterBound: '暂无绑定',
    totalEarned: '累计获得',
    totalSpent: '累计使用',
    bindCodeLabel: '已有好友推荐码',
    bindCodePlaceholder: '输入推荐码',
    bind: '绑定',
    binding: '绑定中',
    bindHint: '每个账号只能绑定一次推荐关系。',
    alreadyBoundHint: '当前账号已绑定邀请人推荐码，不能再次绑定。',
    rewardRules: '奖励规则',
    loadFailed: '推荐功能加载失败',
    linkCopied: '邀请链接已复制',
    codeCopied: '推荐码已复制',
    bindSuccess: '推荐关系绑定成功',
    bindFailed: '推荐关系绑定失败',
    rules: {
      share: {
        title: '分享邀请链接',
        description: '好友通过链接注册后建立推荐关系。'
      },
      purchase: {
        title: '好友完成购买',
        description: '订单完成后按后台规则发放积分。'
      },
      renewal: {
        title: '好友续费自动奖励',
        description: '好友后续续费成功后，也会按后台规则自动发放积分。'
      },
      mall: {
        title: '前往积分商城兑换',
        description: '积分兑换和积分流水已移到独立的积分商城页面。'
      }
    }
  },
  ...
  pointsMall: {
    title: '积分商城',
    description: '使用推荐奖励积分兑换可用订阅权益，并查看最近的积分收入、扣减和兑换记录。',
    kicker: '积分商城',
    currentPoints: '当前积分',
    totalEarned: '累计获得',
    totalSpent: '累计使用',
    redemptionTitle: '积分兑换',
    redemptionDescription: '使用积分兑换订阅套餐，兑换成功后会自动写入积分流水。',
    emptyCatalog: '暂无可兑换套餐',
    validityDays: '{days} 天',
    pointsCost: '{points} 积分',
    referencePrice: '参考价 {amount}',
    redeeming: '兑换中',
    redeemNow: '立即兑换',
    insufficientPoints: '积分不足',
    ledgerTitle: '积分流水',
    ledgerDescription: '最近的积分奖励、扣减和兑换记录。',
    emptyLedger: '暂无积分流水',
    pagination: '共 {total} 条，当前第 {page} 页',
    loadFailed: '积分商城加载失败',
    confirmRedeem: '确认使用 {points} 积分兑换「{title}」吗？',
    redeemSuccess: '兑换成功',
  ...
  admin: {
    ...
    subscriptions: {
      ...
      resetQuotaBackendUnavailable: '后台服务暂不可用，请稍后再试或联系管理员',
    ...
    accounts: {
      ...
      types: {
        ...
        soraApiKeyHint: '连接另一个 PYTHAGORAS 或兼容 API',
      ...
      soraUpstreamBaseUrlHint: '上游 Sora 服务地址（另一个 PYTHAGORAS 实例或兼容 API）',
    ...
    settings: {
      ...
      linuxdo: {
        ...
        description: '配置 LinuxDo Connect OAuth，用于 PYTHAGORAS 用户登录',
  ...
  purchase: {
    title: '充值/订阅',
    description: '直接在站内完成订阅购买或余额充值，支付完成后自动确认订单并触发发货。',
    openInNewTab: '新窗口打开',
    openLegacyPage: '打开旧版购买页',
    queryUnavailable: '当前支付查询未启用，购买仍可创建，但支付结果需要稍后手动确认。',
    notEnabledTitle: '该功能未开启',
    notEnabledDesc: '管理员暂未开启充值/订阅入口，请联系管理员。',
    notConfiguredTitle: '充值/订阅链接未配置',
    notConfiguredDesc: '管理员已开启入口，但尚未配置充值/订阅链接，请联系管理员。',
    loadFailedTitle: '购买页加载失败',
    loadFailedFallback: '加载购买页失败，请稍后重试。',
    retry: '重试',
    currentAccount: '当前发货账号',
    currentAccountHint: '支付成功后，订阅或余额会直接发放到这个账号。',
    userId: '用户 ID',
    queryStatus: '支付查询',
    queryStatusEnabled: '已启用',
    queryStatusDisabled: '未启用',
    emptyCatalogTitle: '暂无可购买商品',
    ...
    redirectingToPay: '订单已创建，正在跳转到支付宝。',
  ...
  orders: {
    title: '订单管理',
    description: '查看当前账号的支付订单、支付状态和发放状态。',
    adminDescription: '查看全部支付订单，并按支付状态、发放状态或关键字筛选。',
    returnTitle: '支付结果确认',
    returnDescription: '浏览器回跳只表示支付流程返回，最终结果以服务端查单和发放状态为准。',
    returnErrorTitle: '订单确认失败',
    returnMissingOrderId: '缺少 merchantOrderId，无法确认订单。',
    returnStatusTitle: '当前订单状态',
    loadFailedTitle: '订单加载失败',
    loadFailedFallback: '加载订单失败，请稍后重试。',
    emptyTitle: '暂无订单',
    emptyDesc: '当前账号还没有符合条件的订单，可以先前往购买页创建新订单。',
    emptyAdminDesc: '当前筛选条件下没有订单记录。',
    keywordPlaceholder: '搜索订单号或 SKU',
    keywordPlaceholderAdmin: '搜索订单号、SKU、邮箱或用户名',
    apply: '查询',
    reset: '重置',
    refresh: '刷新',
    retry: '重试',
    total: '共 {total} 条订单',
    platformOrderNo: '支付流水号',
    lastCheckedAt: '最后查单',
    checkStatus: '刷新状态',
    markPaid: '标记已支付',
    markClosed: '关闭订单',
    ...
    backToOrders: '返回我的订单',
    backToPurchase: '继续购买',
    queryUnavailable: '当前支付查询未启用，列表仍会展示已有订单，但无法自动向支付平台确认最新状态。',
    updateStatusSuccess: '订单状态已更新。',
    updateStatusFailed: '更新订单状态失败，请稍后重试。',
    refreshFailed: '刷新订单状态失败，请稍后重试。',
    unknownError: '未知错误',
    checkResultQueryUnavailable: '支付订单已记录，但当前支付查询暂不可用，请稍后重试或联系管理员处理。',
    checkResultFulfilled: '支付已确认，订阅或余额已成功发放。',
    checkResultFulfillmentFailed: '支付已确认，但发放失败：{reason}',
  ...
  userSubscriptions: {
    ...
    expiresOn: '{date} 到期',
    resetIn: '{time} 后重置',
    trafficQuotaBonus: '今日流量包加成',
    trafficPack: '今日流量包',
    trafficPackQuota: '今日额度从 {base} 提升至 {total}',
    trafficPackExpires: '将在 {time} 失效，届时恢复套餐额度',
    subscriptionQuotaReset: '订阅额度将在 {time} 后重置',
    ...
    resetQuotaOnlyOwn: '只能操作自己的订阅额度',
    resetQuotaNotActive: '只能重置生效中的订阅额度',
    resetQuotaFailed: '额度重置失败',
    resetQuotaServiceUnavailable: '后台服务暂不可用，请稍后再试或联系管理员',
  ...
  onboarding: {
    ...
    admin: {
      ...
      groupManage: {
        title: '📦 第一步：分组管理',
        description:
          '<div style="line-height: 1.7;"><p style="margin-bottom: 12px;"><b>什么是分组？</b></p><p style="margin-bottom: 12px;">分组是 PYTHAGORAS 的核心概念，它就像一个"服务套餐"：</p><ul style="margin-left: 20px; margin-bottom: 12px; font-size: 13px;"><li>🎯 每个分组可以包含多个上游账号</li><li>💰 每个分组有独立的计费倍率</li><li>👥 可以设置为公开或专属分组</li></ul><p style="margin-top: 12px; padding: 8px 12px; background: #f0fdf4; border-left: 3px solid #10b981; border-radius: 4px; font-size: 13px;"><b>💡 示例：</b>您可以创建"VIP专线"（高倍率）和"免费试用"（低倍率）两个分组</p><p style="margin-top: 16px; color: #10b981; font-weight: 600;">👉 点击左侧的"分组管理"开始</p></div>'
      },
      createGroup: {
        title: '➕ 创建新分组',
        description:
    ...
    user: {
      welcome: {
        title: '👋 欢迎使用 PYTHAGORAS',
        description:
          '<div style="line-height: 1.8;"><p style="margin-bottom: 16px;">您好！欢迎来到 PYTHAGORAS AI 服务平台。</p><p style="margin-bottom: 12px;"><b>🎯 快速开始：</b></p><ul style="margin-left: 20px; margin-bottom: 16px;"><li>🔑 创建 API 密钥</li><li>📋 复制密钥到您的应用</li><li>🚀 开始使用 AI 服务</li></ul><p style="color: #10b981; font-weight: 600;">只需 1 分钟，让我们开始吧 →</p></div>',
        nextBtn: '开始 🚀',
        prevBtn: '跳过'
      },
      keyManage: {
