/**
 * Vue Router configuration for PYTHAGORAS frontend
...
const routes: RouteRecordRaw[] = [
  ...
  },
  {
    path: '/points-mall',
    name: 'PointsMall',
    component: () => import('@/views/user/PointsMallView.vue'),
    meta: {
      requiresAuth: true,
      requiresAdmin: false,
      title: 'Points Mall',
      titleKey: 'pointsMall.title',
      descriptionKey: 'pointsMall.description'
    }
  },
  {
    path: '/profile',
...
router.beforeEach((to, _from, next) => {
  ...
  if (to.name === 'CustomPage') {
    ...
    if (menuItem?.label) {
      const siteName = appStore.siteName || 'PYTHAGORAS'
