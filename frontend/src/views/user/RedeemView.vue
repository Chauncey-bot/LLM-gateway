<template>
  <AppLayout>
    <div class="console-page mx-auto max-w-5xl space-y-5">
      <div class="console-title-panel">
        <p class="console-kicker">{{ t('nav.myAccount') }}</p>
        <h1 class="console-section-title">{{ t('redeem.title') }}</h1>
        <p class="console-section-description">{{ t('redeem.description') }}</p>
      </div>
      ...
      <div class="card overflow-hidden">
        <div class="px-6 py-8 text-center">
          <div
            class="mb-4 inline-flex h-16 w-16 items-center justify-center rounded-lg border border-slate-200 bg-slate-50 dark:border-white/10 dark:bg-white/[0.04]"
          >
            <Icon name="creditCard" size="xl" class="text-slate-600 dark:text-slate-300" />
          </div>
          <p class="text-sm font-medium text-slate-500 dark:text-slate-400">{{ t('redeem.currentBalance') }}</p>
          <p class="mt-2 text-4xl font-bold text-slate-950 dark:text-white">
      ...
      <!-- Information Card -->
      <div
        class="surface-tile border-cyan-200/80 bg-cyan-50/70 dark:border-cyan-400/20 dark:bg-cyan-400/10"
      >
        <div class="p-6">
          <div class="flex items-start gap-4">
            <div
        ...
        <div class="p-6">
          ...
          <div v-else-if="history.length > 0" class="space-y-3">
            <div
              ...
              :key="item.id"
              class="surface-tile flex items-center justify-between"
            >
