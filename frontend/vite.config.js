...
export default defineConfig(function (_a) {
    ...
    var backendUrl = env.VITE_DEV_PROXY_TARGET || 'https://ai.zhisales.com';
    var rewardsBackendUrl = env.VITE_REWARDS_PROXY_TARGET || backendUrl;
    var payBackendUrl = env.VITE_PAY_PROXY_TARGET || backendUrl;
