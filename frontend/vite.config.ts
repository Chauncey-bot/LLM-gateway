...
export default defineConfig(({ mode }) => {
  ...
  const backendUrl = env.VITE_DEV_PROXY_TARGET || 'https://ai.zhisales.com'
  const rewardsBackendUrl = env.VITE_REWARDS_PROXY_TARGET || backendUrl
  const payBackendUrl = env.VITE_PAY_PROXY_TARGET || backendUrl
